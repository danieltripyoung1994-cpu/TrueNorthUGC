    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-background/90 backdrop-blur-xl">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 group relative">
          ...
          <img src={newLogoPng} alt="TrueNorthUGC Logo" width={40} height={40} fetchPriority="high" className="h-8 sm:h-10 w-auto group-hover:rotate-6 transition-transform drop-shadow-[0_0_8px_rgba(255,0,128,0.3)] mix-blend-lighten" />
            ...
            <SheetContent side="right" className="w-[280px] sm:w-[350px]">
              <SheetHeader>
                <SheetTitle className="flex items-center gap-2">
                  <img src={newLogoPng} alt="TrueNorthUGC" width={32} height={32} loading="lazy" className="h-8 w-auto mix-blend-lighten" />
